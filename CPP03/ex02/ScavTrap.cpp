...
/*   Updated: 2022/09/26 11:27:14 by barodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    *this = src;
    std::cout << "ScavTrap " << _name << " : was given life as a clone by Dr Vegapunk !" << std::endl;
    return ;
}
...
void	ScavTrap::attack( const std::string & target )
{
	if (--_ep < 0)
        ...
        std::cout << "ScavTrap " << _name << " can't attack. May be asking him gently would work ! Or not..." << std::endl;
	else
